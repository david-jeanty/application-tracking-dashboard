...
const labelClassName = "text-[12px] text-foreground-muted";

/**
 * The working half of the detail page: what to do with this application next.
 *
...
export function QuickUpdate({
  ...
  return (
    <section aria-labelledby="current-heading">
      <h2
        className="border-b border-border pb-2 text-[17px] font-medium text-foreground"
        id="current-heading"
      >
        Current
      </h2>
      ...
      <form action={updateNextActionAction} className="flex flex-col gap-4 pt-6">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          */}
          <p
            className="text-[12px] leading-5 text-foreground-muted"
