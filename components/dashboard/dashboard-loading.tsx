...
export function DashboardLoading() {
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-8 xl:grid-cols-[minmax(0,5fr)_minmax(0,7fr)] xl:gap-10">
        {[0, 1].map((module) => (
          <section
            className="min-h-52 animate-pulse rounded-surface border border-border bg-surface p-5 sm:p-6"
            key={module}
          >
